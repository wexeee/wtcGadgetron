#include "twoEchoFFTGadget.h"
#include "hoNDFFT.h"

namespace Gadgetron{

twoEchoFFTGadget::twoEchoFFTGadget()
  :image_counter_(0)
{

}

int twoEchoFFTGadget::process( GadgetContainerMessage<IsmrmrdReconData>* m1)
{
...
GADGET_FACTORY_DECLARE(twoEchoFFTGadget)
}
